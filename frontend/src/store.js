...
export default new Vuex.Store({
  ...
  actions: {
    ...
    submitForm({ commit, state }, obj) {
      ...
      axios
        .post("https://7esrxsciql.execute-api.us-east-1.amazonaws.com/prod/risks/create/", obj)
    ...
    getFormSchema({commit}, id) {
      axios
        .get(`https://7esrxsciql.execute-api.us-east-1.amazonaws.com/prod/risks/${id}/`)
        .then(function(response) {
    ...
    getRisks({commit}) {
      axios
        .get('https://7esrxsciql.execute-api.us-east-1.amazonaws.com/prod/risks/list/')
        .then(function(response) {
    ...
    submitEntry({commit, state}, obj) {
      axios
        .post("https://7esrxsciql.execute-api.us-east-1.amazonaws.com/prod/risks/entry/", obj)
        .then(function(response) {
          // eslint-disable-next-line
          console.log(response);
